...
"""
clusterOutput = list()
clusterOutput.append("Run;K;level;LnProbData;meanLnLikelihood;varianceLnLikelihood;meanAlpha")
...
def add_output_likelyhood_table(ic):
    line = str(ic.run)+";"+str(ic.k)+";"+ic.level+";"+str(ic.lnProb)+";"+str(ic.meanLikely)+";"+str(ic.varianceLikely)+";"+str(ic.meanAlpha)
...
def go_through_file(filename):
   try:
       ...
       with open(filename,'r') as fp:
           ...
           ic.set_Level(name.split("_")[1].strip())
