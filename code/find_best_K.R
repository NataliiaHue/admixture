...
ggsave("plots/variation-across-runs.pdf", (plt_phonology | plt_morphology | plt_syntax) ,height=3,width=10)
...
ggsave("plots/variation-across-runs.pdf", (phonology_runs_plt | morphology_runs_plt | syntax_runs_plt) ,height=3,width=10)
